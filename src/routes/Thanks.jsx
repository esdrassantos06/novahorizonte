...
const Thanks = () => {
  return (
    <>
      <main className="bg-primary flex h-[70vh] w-full flex-col justify-center">
        ...
        <div className="relative z-10 flex w-full flex-col items-center justify-center gap-5">
          <h1 className="text-text titilliumBold text-center text-6xl">
            Recebemos a sua <span className="text-secondary">mensagem</span>.
          </h1>
          <p className="text-text text-center titilliumRegular">
