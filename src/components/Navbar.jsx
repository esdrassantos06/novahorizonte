...
*/
import image from "../../public/favicon/Favicon.webp";
...
const Navbar = () => {
  ...
  return (
    <header className="bg-primary fixed top-0 z-91 flex h-20 w-full">
      <nav className="flex w-full items-center justify-between">
        ...
        <div
          className={`bg-primary absolute z-19 top-20 left-0 flex min-h-screen items-start justify-start text-start text-nowrap transition-all duration-300 max-md:w-[70%] max-md:pl-10 md:top-1/2 md:left-1/2 md:min-h-0 md:-translate-x-1/2 md:-translate-y-1/2 ${menuOpen ? "scale-y-100 opacity-100" : "max-md:scale-y-0 max-md:opacity-0 md:flex"}`}
        >
          <ul className="titilliumSemiBold z-10 flex flex-col gap-5 max-md:mt-5 max-md:w-[90%] max-md:gap-10 md:flex-row">
