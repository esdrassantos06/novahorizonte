...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] z-100 grid w-full max-w-lg gap-4 border p-6 shadow-lg duration-200 data-[state=open]:animate-scale-in-center data-[state=closed]:animate-scale-out-center sm:rounded-lg",
        className
      )}
      {...props}>
      {children}
