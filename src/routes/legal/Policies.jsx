    ...
    return (
        <>
            <div className="w-full mx-auto px-6 py-10 text-white flex flex-col items-center titilliumRegular bg-primary min-h-screen">
                ...
                <h2 className="text-2xl font-semibold text-secondary mt-6 mb-2">Compromisso do Usuário</h2>
                <p className="mb-4">O usuário se compromete a fazer uso adequado dos conteúdos e informações que o <strong>Nova Horizonte</strong> oferece no site, incluindo mas não se limitando a:</p>
                <ul className="list-disc pl-6 space-y-2">
                    <li>Não se envolver em atividades ilegais ou contrárias à boa fé e à ordem pública.</li>
                    <li>Não difundir propaganda ou conteúdo racista, xenofóbico, de azar, pornografia ilegal, apologia ao terrorismo ou contra os direitos humanos.</li>
                ...
                <p className="mb-4">Se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>
            </div>
            <Footer/>
    </>
    )
